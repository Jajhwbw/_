...
from source.Data import db, dev, devname, set_must
...
async def alivehi(client: Client, message):
    ...
    await message.reply_video(
        video=VIDEO,
        caption="╭───── : ◖⋮◗ : ─────╮\n么 [𝐎ꪶ𝐋ٓ𝐄𝐕ِ𝐑┊͙🚸ݪـي٘فـࢪꪆُﺎ](https://t.me/L_HLN)\n么 [𝘼𝙑⍢⃝𝙎𝙊𝙐𝙍𝘾𝞝](https://t.me/sourceav)\n么 [₍ 𝑘 𝑖 𝑛 𝑔 || كـ ٖ ـيـنــج ⁾ ↺](https://t.me/TR_E2S_ON_MY_MOoN)\n╰──── : ◖⋮◗ : ────╯\n: ƚ𝗁ᥱ Ⴆᥱ᥉ƚ ᥉᥆υᖇᥴᥱ ᥆ꪀ ƚᥱᥣᥱᘜᖇᥲ️ꪔ :",
        reply_markup=keyboard,
    )

@app.on_message(filters.command(["صاحب السورس", "زين", "مطور السورس",": مطور السورس :"], "") & ~filters.private)
